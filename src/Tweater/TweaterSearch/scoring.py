...
def score(object, SearchTerm_id):
    ...
    try:
        ...
        db = MySQLdb.connect("localhost","root","Pertrac2@","mysql_tweater")
    ...
    # TO DO HERE: get database name from settings, deal with hardcoding in general
    sql = """CALL mysql_tweater.sp_ScoreSearchTerm(%s)"""
    try:
